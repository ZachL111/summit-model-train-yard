"""Regression checks for the summit-model-train-yard casebook."""
...
from casebook.harness import assert_expected, summit_model_train_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_model_train_yard_summary(), assert_expected())
